...
from menu_pedidos import cargar_menu
from colores import *
from imagenes import (cargar_logos, cargar_icono_usuario, cargar_icono_contraseña, cargar_icono_login)
import os


def boton_estilo(parent, texto, comando, color=rojo, icono=None):
    btn = tk.Button(
        parent,
        text=texto,
        command=comando,
    ...
    def hover_on(e):
        btn.config(bg=rojo if color == rojo else cafe_claro)
...
def abrir_login():
    ...
    icono_pass = cargar_icono_contraseña()
    ...
    if datos_guardados:
        ...
        contrasena_var.set(datos_guardados["contrasena"])
